...
const cli_js_1 = require("../src/lib/cli.js");
const moduleNames = (0, cli_js_1.getModuleNames)(index_js_1.default.prototype);
...
async function main() {
    const exitCode = await (0, cli_js_1.runCli)({
