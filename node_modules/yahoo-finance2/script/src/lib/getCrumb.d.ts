 ...
 */
export declare function _getCrumb(cookieJar: ExtendedCookieJar, fetch: Fetch, fetchOptionsBase: CrumbOptions, logger: Logger, url?: string, develOverride?: Partial<YahooFinanceFetchModuleOptions["devel"]>, noCache?: boolean, depth?: number): Promise<string | null>;
/**
