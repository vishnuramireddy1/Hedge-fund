    ...
    namespace definitions {
        ...
        namespace AssetProfile {
            ...
            export namespace properties_1 {
                ...
                namespace blockRewardReduction {
                    let type_38: string;
                    export { type_38 as type };
                }
                namespace netHashesPerSecond {
                    let type_39: string;
        ...
        namespace QuoteSummaryEarnings {
            ...
            export namespace properties_10 {
                ...
                export namespace defaultMethodology_1 {
                    let type_85: string;
                    export { type_85 as type };
                    let _enum_1: string[];
                    export { _enum_1 as enum };
                }
                export { defaultMethodology_1 as defaultMethodology };
            }
        ...
        namespace EarningsChart {
            ...
            export namespace properties_11 {
                ...
                export namespace currentCalendarQuarter {
                    let type_94: string;
                    export { type_94 as type };
                }
                export namespace currentFiscalQuarter {
                    let type_95: string;
                    export { type_95 as type };
                }
                export namespace currentPeriodEndDate {
                    let type_96: string;
        ...
        namespace EarningsChartQuarterly {
            ...
            export namespace properties_12 {
                ...
                namespace fiscalQuarter {
                    let type_101: string;
                    export { type_101 as type };
                }
                namespace calendarQuarter {
                    let type_102: string;
        ...
        namespace FinancialsChartQuarterly {
            ...
            export namespace properties_15 {
                ...
                export namespace fiscalQuarter_1 {
                    let type_119: string;
                    export { type_119 as type };
                }
                export { fiscalQuarter_1 as fiscalQuarter };
                export namespace profitMargin_1 {
                    let type_120: string;
                    export { type_120 as type };
                }
                export { profitMargin_1 as profitMargin };
            }
        ...
        namespace EarningsHistory {
            ...
            export namespace properties_16 {
                ...
                export namespace defaultMethodology_2 {
                    let type_124: string;
                    export { type_124 as type };
                    let _enum_2: string[];
                    export { _enum_2 as enum };
                }
                export { defaultMethodology_2 as defaultMethodology };
            }
        ...
        namespace EarningsTrend {
            ...
            export namespace properties_18 {
                ...
                export namespace defaultMethodology_3 {
                    let type_136: string;
                    export { type_136 as type };
                    let _enum_3: string[];
                    export { _enum_3 as enum };
                }
                export { defaultMethodology_3 as defaultMethodology };
            }
        ...
        namespace NetSharePurchaseActivity {
            ...
            export namespace properties_51 {
                ...
                export namespace netInstSharesBuying {
                    let type_393: string;
                    export { type_393 as type };
                }
                export namespace netInstBuyingPercent {
                    let type_394: string;
        ...
        namespace SummaryDetail {
            ...
            export namespace properties_59 {
                ...
                export namespace fullyDilutedValue {
                    let type_525: string;
                    export { type_525 as type };
                }
                export namespace volume24HrMarketCapPercent {
                    let type_526: string;
                ...
                export namespace nonDilutedMarketCap {
                    let type_540: string;
                    export { type_540 as type };
                }
                export namespace allTimeHigh {
                    let type_541: string;
                    export { type_541 as type };
                }
                export namespace allTimeLow {
                    let type_542: string;
        ...
        namespace SummaryProfile {
            ...
            export namespace properties_60 {
                ...
                export namespace whitepaper_1 {
                    let type_570: string;
                    export { type_570 as type };
                }
                export { whitepaper_1 as whitepaper };
                export namespace blockNumber_1 {
                    let type_571: string;
                    export { type_571 as type };
                }
                export { blockNumber_1 as blockNumber };
                export namespace blockReward_1 {
                    let type_572: string;
                    export { type_572 as type };
                }
                export { blockReward_1 as blockReward };
                export namespace blockRewardReduction_1 {
                    let type_573: string;
                    export { type_573 as type };
                }
                export { blockRewardReduction_1 as blockRewardReduction };
                export namespace netHashesPerSecond_1 {
                    let type_574: string;
                    export { type_574 as type };
                }
                export { netHashesPerSecond_1 as netHashesPerSecond };
            }
        ...
        namespace UpgradeDowngradeHistoryHistory {
            ...
            export namespace properties_67 {
                ...
                namespace priceTargetAction {
                    let type_632: string;
                    export { type_632 as type };
                    let _enum_7: string[];
                    export { _enum_7 as enum };
                }
                namespace currentPriceTarget {
                    let type_633: string;
                    export { type_633 as type };
                }
                namespace priorPriceTarget {
                    let type_634: string;
